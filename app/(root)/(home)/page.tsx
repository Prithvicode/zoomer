...
const Home = () => {
  ...
  return (
    <div className="relative max-sm:w-full  h-full rounded-lg  ">
      <div className="bg-bg-3 w-full h-[300px] rounded-lg -z-10 text-slate-950 text-xl max-sm:text-md font-bold p-8 max-sm:p-2 max-lg:p-4 max-md:h-[250px] flex justify-between ">
        <div className="relative z-10 flex flex-col gap-3  h-full w-full justify-around px-9 max-md:justify-center max-md:items-center max-md:gap-6">
          ...
          <div>
            ...
            <h2 className="text-8xl max-md:text-6xl font-extrabold z-10 bg-gradient-to-r from-blue-500  to-blue-950 bg-clip-text text-transparent">
              {currentTime}
            </h2>
          </div>
        </div>
